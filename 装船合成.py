...
excel_files = ['场桥10.xlsx', '场桥11.xlsx', '场桥12.xlsx', '场桥13.xlsx', '场桥14.xlsx', '场桥15.xlsx', '场桥16.xlsx',
               '场桥17.xlsx', '场桥18.xlsx', '岸桥1及AGV能耗2.xlsx', '岸桥2及AGV能耗2.xlsx', '岸桥3及AGV能耗2.xlsx']  # 替换为您的文件名
...
final_results.to_excel('total_energy_demand2.xlsx', index=False, header=False)